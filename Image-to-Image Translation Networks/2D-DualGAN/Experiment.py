...
# Which model do you want to use? choose among: 'DualGan'
network_structure = 'DualGan'    
...
preprocessed_dataset_path = os.path.join(base_project_dir, 'Data', 'Split_Data')
