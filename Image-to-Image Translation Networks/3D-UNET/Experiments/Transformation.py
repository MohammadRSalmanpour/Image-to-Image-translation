    ...
    def generate_output(self):
        ...
        for set_name in ['train', 'val', 'test']:
            ...
            for i, (US, gt_MRI) in tqdm(enumerate(dataset)):
                ...
                pred_nii_img = nib.Nifti1Image(pred_MRI)
                ...
                diff_nii_img = nib.Nifti1Image(diff_MRI)
            ...
            dict_metrics_all = {'Patient ID': file_name_list, 'MAE': mae_list, 'MAPE': mape_list, 'RMSE': rmse_list, 'SSI': ssi_list}
            df_metrics_all = pd.DataFrame(dict_metrics_all)
