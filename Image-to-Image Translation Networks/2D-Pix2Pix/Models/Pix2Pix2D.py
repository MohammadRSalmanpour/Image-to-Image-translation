...
class Pix2Pix():
  ...
  def fit(self, train_data, control_US, control_MRI):
    example_us, example_mri = control_US, control_MRI
    ...
    for epoch in range(max_epochs):
      ...
      path_epoch_save = os.path.join(self.args['last_models_dir'], 'Epoch{}'.format(epoch + 1))
      os.mkdir(path_epoch_save)
      self.generator.save_weights(os.path.join(path_epoch_save, 'Generator.h5'))
      self.discriminator.save_weights(os.path.join(path_epoch_save, 'Discriminator.h5'))
      ...
      epoch_numbers = range(1, len(gen_total_loss_list) + 1)
      plt.plot(epoch_numbers, gen_total_loss_list, "r", label="gen_total_loss")
      plt.plot(epoch_numbers, disc_loss_list, "b", label="disc_loss")
      plt.title("The Value of Losses in Epoch{}".format(epoch + 1))
      plt.legend()
      plt.savefig(os.path.join(path_epoch_save, 'loss_graph_epoch{}.png'.format(epoch + 1)))
      plt.close()
