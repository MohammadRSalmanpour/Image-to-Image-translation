# -*- coding: utf-8 -*-
"""
Created on Thu Jan 18 19:13:47 2024
...
def ResNet50_AB(input_size: Tuple[int,int,int], classes: int) -> Model:
    """
    ...
    # Output layer
    X = Flatten()(X)
    X = Dense(classes, activation='sigmoid', name='fc_' + str(classes),
              kernel_initializer=glorot_uniform(seed=0))(X)
